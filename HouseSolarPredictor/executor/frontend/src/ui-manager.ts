...
export class UIManager {
    ...
    updateCurrentMetrics(metrics: MetricInstance): void {
        ...
        const remainingBatteryKwh = (metrics.batteryCharge || 0).toFixed(2);
        const remainingBatteryPercentage = ((metrics.batteryCharge || 0) * 10).toFixed(1); // Assuming 10kWh max capacity
